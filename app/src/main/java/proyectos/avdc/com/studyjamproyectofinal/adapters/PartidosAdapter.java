...
public class PartidosAdapter extends RecyclerView.Adapter<PartidosViewHolder> {
    ...
    private List<PartidosItem> itemsFiltrados;
    ...
    public void onBindViewHolder(final PartidosViewHolder eventosViewHolder, int i) {
        ...
        eventosViewHolder.txtMarcador.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(context,"Detalles del partido",Toast.LENGTH_LONG).show();
            }
        });
    }
