...
public class PartidosItem {
    ...
    //TODO: Se puede vincular ID equipo
    public int intIdEquipo1;
    public int intIdEquipo2;


    public PartidosItem() {
    }

    public PartidosItem(int intIdPartido, String strNombreEquipo1, String strNombreEquipo2, String strTextoMarcador, String strTextoCentral, int intImgEquipo1, int intImgEquipo2) {
